...
#
# 2016 Martin Wheldon <martin.wheldon@greenhills-it.co.uk>
# 2016 Salvo Rapisarda
# 2014 - 2018 Cornelius Kölbel <cornelius@privacyidea.org>
#
...
class IdResolver (UserIdResolver):
    ...
    def _ldap_attributes_to_user_object(self, attributes):
        ...
        the eduMFA user. The LDAP Userinfo mapping is used to do so.

        :param attributes:
        :return: dict with eduMFA users.
        """
        ret = {}
